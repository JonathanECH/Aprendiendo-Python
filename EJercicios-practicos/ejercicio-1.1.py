...
print(f" - un {round(difernecia_con_max , 2)}% menos que es mas lento")#round(num,2) esto lo que hacen es que redondea el numero a dos decimales
...
print(f"Este curso elimina un {round(tiempo_vacio_este,2)}% de tiempo vacio")
print("---------------------")

#Mostrar la diferencia si los cursos duraran 10 horas (ejercicio C)
print(f"Ver 10 horas de este curso equivale a ver {round((otros_cursos_promedio / este_curso * 10) , 2)} horas de otros cursos")
print(f"Ver 10 horas de otros curso equivale a ver {round((este_curso / otros_cursos_promedio * 10) , 2)} horas de este curso")
print("---------------------")